...
function _M0FP38portable8research17researchartifacts20review__source__refs(review) {
  const out = [];
  if (review.$tag === 6) {
    const _Object = review;
    const _fields = _Object._0;
    const _bind = _M0MPB3Map3getGsRPB4JsonE(_fields, "reviews");
    if (_bind === undefined) {
    } else {
      const _Some = _bind;
      const _x = _Some;
      if (_x.$tag === 5) {
        ...
        const _bind$2 = _reviews.length;
        let _tmp = 0;
        while (true) {
          const _ = _tmp;
          if (_ < _bind$2) {
            const item = _reviews[_];
            if (item.$tag === 6) {
              const _Object$2 = item;
              const _entry = _Object$2._0;
              const _p = _M0MPB3Map3getGsRPB4JsonE(_entry, "findingId");
              ...
              const _bind$3 = _M0MPB3Map3getGsRPB4JsonE(_entry, "sourceChecks");
              if (_bind$3 === undefined) {
              } else {
                const _Some$2 = _bind$3;
                const _x$2 = _Some$2;
                if (_x$2.$tag === 5) {
                  const _Array$2 = _x$2;
                  const _checks = _Array$2._0;
                  const _bind$4 = _checks.length;
                  let _tmp$2 = 0;
                  while (true) {
                    const _$2 = _tmp$2;
                    if (_$2 < _bind$4) {
                      const check = _checks[_$2];
                      if (check.$tag === 6) {
                        const _Object$3 = check;
                        const _check_fields = _Object$3._0;
                        const _tmp$3 = { _0: "findingId", _1: finding_id };
                        const _p$3 = _M0MPB3Map3getGsRPB4JsonE(_check_fields, "path");
                        const _p$4 = _M0DTPB4Json4Null__;
                        let _tmp$4;
                        if (_p$3 === undefined) {
                          _tmp$4 = _p$4;
                        } else {
                        ...
                        const _tmp$5 = { _0: "path", _1: _tmp$4 };
                        const _p$5 = _M0MPB3Map3getGsRPB4JsonE(_check_fields, "line");
                        ...
                        const _tmp$7 = { _0: "line", _1: _tmp$6 };
                        const _p$7 = _M0MPB3Map3getGsRPB4JsonE(_check_fields, "quote");
                        const _p$8 = _M0DTPB4Json4Null__;
                        let _tmp$8;
                        if (_p$7 === undefined) {
                          _tmp$8 = _p$8;
                        } else {
                        ...
                        const _tmp$9 = { _0: "quote", _1: _tmp$8 };
                        const _p$9 = _M0MPB3Map3getGsRPB4JsonE(_check_fields, "kind");
                        const _p$10 = _M0DTPB4Json4Null__;
                        let _tmp$10;
                        if (_p$9 === undefined) {
                          _tmp$10 = _p$10;
                        } else {
                        ...
                        const _bind$5 = [_tmp$3, _tmp$5, _tmp$7, _tmp$9, { _0: "kind", _1: _tmp$10 }];
                        const _p$11 = _M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$5, 0, 5));
                        _M0MPC15array5Array4pushGsE(out, new _M0DTPB4Json6Object(_p$11));
                      }
                      _tmp$2 = _$2 + 1 | 0;
                      continue;
                    } else {
...
function _M0FP38portable8research17researchartifacts6review(host, packet_path, candidate_path, draft_path, out) {
  const _bind = _M0FP38portable8research17researchartifacts21load__packet__sources(host, packet_path);
  let _bind$2;
  if (_bind.$tag === 1) {
    const _ok = _bind;
  ...
  const _root = _bind$2._1;
  const _sources = _bind$2._2;
  const _bind$3 = _M0FP38portable8research17researchartifacts12read__record(host, candidate_path);
  let candidate;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    candidate = _ok._0;
  ...
  const _bind$4 = _M0FP38portable8research2io8required(candidate, "sha256");
  let _tmp;
  if (_bind$4.$tag === 1) {
    const _ok = _bind$4;
    _tmp = _ok._0;
  ...
  const _bind$5 = _M0FP38portable8research2io10as__string(_tmp);
  let candidate_sha;
  if (_bind$5.$tag === 1) {
    const _ok = _bind$5;
  ...
  const _bind$6 = _M0FP38portable8research2io8required(candidate, "text");
  let _tmp$2;
  if (_bind$6.$tag === 1) {
    const _ok = _bind$6;
    _tmp$2 = _ok._0;
  ...
  const _bind$7 = _M0FP38portable8research2io10as__string(_tmp$2);
  let candidate_text;
  if (_bind$7.$tag === 1) {
    const _ok = _bind$7;
  ...
  const _bind$8 = _M0FP38portable8research2io4read(host, draft_path);
  let _tmp$3;
  if (_bind$8.$tag === 1) {
    const _ok = _bind$8;
    _tmp$3 = _ok._0;
  ...
  const _bind$9 = _M0FP38portable8research2io5parse(_tmp$3);
  let draft;
  if (_bind$9.$tag === 1) {
    const _ok = _bind$9;
    draft = _ok._0;
  ...
  const _p = "buildReview";
  const _tmp$4 = { _0: "op", _1: new _M0DTPB4Json6String(_p) };
  const _tmp$5 = { _0: "packet", _1: new _M0DTPB4Json6Object(_packet) };
  const _tmp$6 = { _0: "sources", _1: new _M0DTPB4Json5Array(_sources) };
  const _tmp$7 = { _0: "candidateSha256", _1: new _M0DTPB4Json6String(candidate_sha) };
  const _bind$10 = _M0FP38portable8research2io5parse(candidate_text);
  let _tmp$8;
  if (_bind$10.$tag === 1) {
    const _ok = _bind$10;
    _tmp$8 = _ok._0;
  ...
  const _bind$11 = [_tmp$4, _tmp$5, _tmp$6, _tmp$7, { _0: "candidateValue", _1: _tmp$8 }, { _0: "draft", _1: draft }];
  const _p$2 = _M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$11, 0, 6));
  const request = new _M0DTPB4Json6Object(_p$2);
  const _bind$12 = _M0FP38portable8research17researchartifacts14dispatch__core(request);
  let answer;
  if (_bind$12.$tag === 1) {
    const _ok = _bind$12;
    answer = _ok._0;
  ...
  const _bind$13 = _M0FP38portable8research2io10as__object(answer);
  let fields;
  if (_bind$13.$tag === 1) {
    const _ok = _bind$13;
    fields = _ok._0;
  ...
  const _bind$14 = _M0FP38portable8research17researchartifacts6is__ok(fields);
  let _tmp$9;
  if (_bind$14.$tag === 1) {
    const _ok = _bind$14;
    _tmp$9 = _ok._0;
  ...
  const _bind$15 = _M0FP38portable8research2io8required(fields, "review");
  let review_value;
  if (_bind$15.$tag === 1) {
    const _ok = _bind$15;
    review_value = _ok._0;
  ...
  const refs = _M0FP38portable8research17researchartifacts20review__source__refs(review_value);
  const _bind$16 = _M0FP38portable8research17researchartifacts7publish(host, "review", out, _root, [{ _0: "draft.json", _1: _M0FP38portable8research17researchartifacts6pretty(draft) }, { _0: "review.json", _1: _M0FP38portable8research17researchartifacts6pretty(review_value) }, { _0: "source-refs.json", _1: _M0FP38portable8research17researchartifacts6pretty(refs) }], _M0MPB3Map11new_2einnerGsRPB4JsonE(8));
  if (_bind$16.$tag === 1) {
    const _ok = _bind$16;
    _ok._0;
  } else {
...
function _M0FP38portable8research17researchartifacts15revised__packet(packet, candidate, candidate_hash, responses) {
  let peer;
  _L: {
    _L$2: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(packet, "peerReview");
      if (_bind === undefined) {
        break _L$2;
      } else {
        const _Some = _bind;
        ...
        if (_x.$tag === 6) {
          const _Object = _x;
          const _fields = _Object._0;
          peer = _M0FP38portable8research17researchartifacts5clone(_fields);
        } else {
          break _L$2;
        }
      }
    ...
    peer = _M0MPB3Map11new_2einnerGsRPB4JsonE(8);
  }
  const _bind = _M0MPB3Map3getGsRPB4JsonE(peer, "round");
  let round;
  if (_bind === undefined) {
    round = 0;
  } else {
    ...
    if (_x.$tag === 3) {
      const _Number = _x;
      const _number = _Number._0;
      round = _M0MPC16double6Double7to__int(_number);
    } else {
      round = 0;
    }
  }
  const _p = (round + 1 | 0) + 0;
  const _p$2 = undefined;
  _M0MPB3Map3setGsRPB4JsonE(peer, "round", new _M0DTPB4Json6Number(_p, _p$2));
  _M0MPB3Map3setGsRPB4JsonE(peer, "reviewedArtifactSha256", new _M0DTPB4Json6String(candidate_hash));
  _M0MPB3Map3setGsRPB4JsonE(peer, "candidateDraft", candidate);
  _M0MPB3Map3setGsRPB4JsonE(peer, "authorResponses", responses);
  const out = _M0FP38portable8research17researchartifacts5clone(packet);
  _M0MPB3Map3setGsRPB4JsonE(out, "peerReview", new _M0DTPB4Json6Object(peer));
  return new _M0DTPB4Json6Object(out);
}
function _M0FP38portable8research17researchartifacts6revise(host, packet_path, candidate_path, review_path, draft_path, out) {
  const _bind = _M0FP38portable8research17researchartifacts21load__packet__sources(host, packet_path);
  let _bind$2;
  if (_bind.$tag === 1) {
    const _ok = _bind;
  ...
  const _bind$8 = _M0FP38portable8research2io5parse(candidate_text);
  let candidate_value;
  if (_bind$8.$tag === 1) {
    const _ok = _bind$8;
    candidate_value = _ok._0;
  ...
  const _bind$9 = _M0FP38portable8research2io4read(host, review_path);
  let _tmp$3;
  if (_bind$9.$tag === 1) {
    const _ok = _bind$9;
    _tmp$3 = _ok._0;
  ...
  const _bind$10 = _M0FP38portable8research2io5parse(_tmp$3);
  let review_value;
  if (_bind$10.$tag === 1) {
    const _ok = _bind$10;
    review_value = _ok._0;
  ...
  _M0MPB3Map3setGsRPB4JsonE(validation, "op", new _M0DTPB4Json6String(_p));
  _M0MPB3Map3setGsRPB4JsonE(validation, "sources", new _M0DTPB4Json5Array(_sources));
  _M0MPB3Map3setGsRPB4JsonE(validation, "candidateSha256", new _M0DTPB4Json6String(candidate_sha));
  _M0MPB3Map3setGsRPB4JsonE(validation, "packet", new _M0DTPB4Json6Object(_packet));
  _M0MPB3Map3setGsRPB4JsonE(validation, "review", review_value);
  const _bind$11 = _M0MPB3Map3getGsRPB4JsonE(_packet, "peerReview");
  if (_bind$11 === undefined) {
    ...
    if (_x.$tag === 6) {
      const _Object = _x;
      const _peer = _Object._0;
      const _bind$12 = _M0MPB3Map3getGsRPB4JsonE(_peer, "candidateDraft");
      if (_bind$12 === undefined) {
        ...
        if (_x$2.$tag === 0) {
          ...
          _M0MPB3Map3setGsRPB4JsonE(validation, "candidateValue", candidate_value);
        }
      }
    }
  }
  const _bind$12 = _M0FP38portable8research17researchartifacts14dispatch__core(new _M0DTPB4Json6Object(validation));
  let _tmp$4;
  if (_bind$12.$tag === 1) {
    const _ok = _bind$12;
    _tmp$4 = _ok._0;
  ...
  const _bind$14 = _M0FP38portable8research17researchartifacts6is__ok(checked);
  let _tmp$5;
  if (_bind$14.$tag === 1) {
    const _ok = _bind$14;
    _tmp$5 = _ok._0;
  ...
  if (!_tmp$5) {
    return new _M0DTPC16result6ResultGRPB4JsonRP38portable8research2io7IoErrorE2Ok(new _M0DTPB4Json6Object(checked));
  }
  const _bind$15 = _M0FP38portable8research2io10as__object(review_value);
  let review_obj;
  if (_bind$15.$tag === 1) {
    const _ok = _bind$15;
    review_obj = _ok._0;
  ...
  const _bind$16 = _M0FP38portable8research2io8required(review_obj, "peerReview");
  let _tmp$6;
  if (_bind$16.$tag === 1) {
    const _ok = _bind$16;
    _tmp$6 = _ok._0;
  ...
  const _bind$17 = _M0FP38portable8research2io10as__object(_tmp$6);
  let review_peer;
  if (_bind$17.$tag === 1) {
    const _ok = _bind$17;
    review_peer = _ok._0;
  ...
  const _bind$18 = _M0FP38portable8research2io8required(review_peer, "issues");
  let review_issues;
  if (_bind$18.$tag === 1) {
    const _ok = _bind$18;
    review_issues = _ok._0;
  } else {
    return _bind$18;
  }
  const _bind$19 = _M0FP38portable8research2io8required(_packet, "peerReview");
  let _tmp$7;
  if (_bind$19.$tag === 1) {
    const _ok = _bind$19;
    _tmp$7 = _ok._0;
  ...
  const _bind$20 = _M0FP38portable8research2io10as__object(_tmp$7);
  let _tmp$8;
  if (_bind$20.$tag === 1) {
    const _ok = _bind$20;
    _tmp$8 = _ok._0;
  ...
  const packet_peer_fields = _M0FP38portable8research17researchartifacts5clone(_tmp$8);
  _M0MPB3Map3setGsRPB4JsonE(packet_peer_fields, "previousIssues", review_issues);
  const packet_with_issues = _M0FP38portable8research17researchartifacts5clone(_packet);
  _M0MPB3Map3setGsRPB4JsonE(packet_with_issues, "peerReview", new _M0DTPB4Json6Object(packet_peer_fields));
  const _bind$21 = _M0FP38portable8research2io4read(host, draft_path);
  let _tmp$9;
  if (_bind$21.$tag === 1) {
    const _ok = _bind$21;
    _tmp$9 = _ok._0;
  ...
  const _bind$22 = _M0FP38portable8research2io5parse(_tmp$9);
  let draft;
  if (_bind$22.$tag === 1) {
    const _ok = _bind$22;
    draft = _ok._0;
  ...
  const _p$2 = "buildRevision";
  const _bind$23 = [{ _0: "op", _1: new _M0DTPB4Json6String(_p$2) }, { _0: "packet", _1: new _M0DTPB4Json6Object(packet_with_issues) }, { _0: "sources", _1: new _M0DTPB4Json5Array(_sources) }, { _0: "candidateSha256", _1: new _M0DTPB4Json6String(candidate_sha) }, { _0: "candidateValue", _1: candidate_value }, { _0: "draft", _1: draft }];
  const _p$3 = _M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$23, 0, 6));
  const request = new _M0DTPB4Json6Object(_p$3);
  const _bind$24 = _M0FP38portable8research17researchartifacts14dispatch__core(request);
  let answer;
  if (_bind$24.$tag === 1) {
    const _ok = _bind$24;
    answer = _ok._0;
  ...
  const _bind$25 = _M0FP38portable8research2io10as__object(answer);
  let fields;
  if (_bind$25.$tag === 1) {
    const _ok = _bind$25;
    fields = _ok._0;
  ...
  const _bind$26 = _M0FP38portable8research17researchartifacts6is__ok(fields);
  let _tmp$10;
  if (_bind$26.$tag === 1) {
    const _ok = _bind$26;
    _tmp$10 = _ok._0;
  ...
  const _bind$27 = _M0FP38portable8research2io8required(fields, "candidate");
  let candidate_new;
  if (_bind$27.$tag === 1) {
    const _ok = _bind$27;
    candidate_new = _ok._0;
  } else {
    return _bind$27;
  }
  const _bind$28 = _M0FP38portable8research2io8required(fields, "issueResponses");
  let responses;
  if (_bind$28.$tag === 1) {
    const _ok = _bind$28;
    responses = _ok._0;
  ...
  const _bind$29 = _M0FP38portable8research2io8required(fields, "remainingChecks");
  let remaining;
  if (_bind$29.$tag === 1) {
    const _ok = _bind$29;
    remaining = _ok._0;
  ...
  const _bind$30 = _M0FP38portable8research2io8required(fields, "sourceRefs");
  let refs;
  if (_bind$30.$tag === 1) {
    const _ok = _bind$30;
    refs = _ok._0;
  ...
  const candidate_text_out = _M0FP38portable8research17researchartifacts6pretty(candidate_new);
  const _bind$31 = _M0FP38portable8research2io10hash__text(host, candidate_text_out);
  let candidate_hash;
  if (_bind$31.$tag === 1) {
    const _ok = _bind$31;
    candidate_hash = _ok._0;
  ...
  const packet_new = _M0FP38portable8research17researchartifacts15revised__packet(packet_with_issues, candidate_new, candidate_hash, responses);
  const _bind$32 = _M0FP38portable8research17researchartifacts7publish(host, "revise", out, _root, [{ _0: "candidate.json", _1: candidate_text_out }, { _0: "packet.json", _1: _M0FP38portable8research17researchartifacts6pretty(packet_new) }, { _0: "draft.json", _1: _M0FP38portable8research17researchartifacts6pretty(draft) }, { _0: "source-refs.json", _1: _M0FP38portable8research17researchartifacts6pretty(refs) }], _M0MPB3Map11new_2einnerGsRPB4JsonE(8));
  if (_bind$32.$tag === 1) {
    const _ok = _bind$32;
    _ok._0;
  } else {
  ...
  const _p$4 = true;
  const _bind$33 = [{ _0: "ok", _1: _p$4 ? _M0DTPB4Json4True__ : _M0DTPB4Json5False__ }, { _0: "receipt", _1: _M0DTPB4Json4Null__ }, { _0: "remainingChecks", _1: remaining }];
  const _p$5 = _M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$33, 0, 3));
...
function _M0FP38portable8research20researchartifactscli13err__envelope(code) {
  const _p = false;
  const _tmp = { _0: "ok", _1: _p ? _M0DTPB4Json4True__ : _M0DTPB4Json5False__ };
  const _bind = [{ _0: "code", _1: new _M0DTPB4Json6String(code) }];
  const _p$2 = _M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 1));
...
function _M0FP38portable8research20researchartifactscli8is__flag(name) {
...
function _M0FP38portable8research20researchartifactscli11parse__args(args) {
  if (args.length === 0) {
  ...
  if (!_M0MPC15array5Array8containsGsE(["research", "review", "revise", "export-peer"], command)) {
  ...
  while (true) {
    if (index < args.length) {
      ...
      if (!_M0FP38portable8research20researchartifactscli8is__flag(name)) {
...
function _M0FP38portable8research20researchartifactscli12check__flags(flags, allowed) {
...
function _M0FP38portable8research20researchartifactscli10need__flag(flags, name) {
...
function _M0FP38portable8research20researchartifactscli3run(input, host) {
  ...
  const _bind$6 = _M0FP38portable8research20researchartifactscli11parse__args(args);
  let _bind$7;
  if (_bind$6.$tag === 1) {
    const _ok = _bind$6;
    _bind$7 = _ok._0;
  ...
  switch (_command) {
    case "research": {
      const _bind$8 = _M0FP38portable8research20researchartifactscli12check__flags(_flags, ["--packet", "--draft", "--out"]);
      if (_bind$8.$tag === 1) {
        const _ok = _bind$8;
        _ok._0;
      } else {
      ...
      const _bind$9 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--packet");
      let _tmp$4;
      if (_bind$9.$tag === 1) {
        const _ok = _bind$9;
        _tmp$4 = _ok._0;
      ...
      const _tmp$5 = _tmp$4;
      const _bind$10 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--draft");
      let _tmp$6;
      if (_bind$10.$tag === 1) {
        const _ok = _bind$10;
        _tmp$6 = _ok._0;
      ...
      const _tmp$7 = _tmp$6;
      const _bind$11 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--out");
      let _tmp$8;
      if (_bind$11.$tag === 1) {
        const _ok = _bind$11;
        _tmp$8 = _ok._0;
      ...
      return _M0FP38portable8research17researchartifacts8research(host, _tmp$5, _tmp$7, _tmp$8);
    }
    case "review": {
      const _bind$12 = _M0FP38portable8research20researchartifactscli12check__flags(_flags, ["--packet", "--candidate", "--draft", "--out"]);
      if (_bind$12.$tag === 1) {
        const _ok = _bind$12;
        _ok._0;
      } else {
      ...
      const _bind$13 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--packet");
      let _tmp$9;
      if (_bind$13.$tag === 1) {
        const _ok = _bind$13;
        _tmp$9 = _ok._0;
      ...
      const _bind$14 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--candidate");
      let _tmp$11;
      if (_bind$14.$tag === 1) {
        const _ok = _bind$14;
        _tmp$11 = _ok._0;
      ...
      const _bind$15 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--draft");
      let _tmp$13;
      if (_bind$15.$tag === 1) {
        const _ok = _bind$15;
        _tmp$13 = _ok._0;
      ...
      const _tmp$14 = _tmp$13;
      const _bind$16 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--out");
      let _tmp$15;
      if (_bind$16.$tag === 1) {
        const _ok = _bind$16;
        _tmp$15 = _ok._0;
      ...
      return _M0FP38portable8research17researchartifacts6review(host, _tmp$10, _tmp$12, _tmp$14, _tmp$15);
    }
    case "revise": {
      const _bind$17 = _M0FP38portable8research20researchartifactscli12check__flags(_flags, ["--packet", "--candidate", "--review", "--draft", "--out"]);
      if (_bind$17.$tag === 1) {
        const _ok = _bind$17;
        _ok._0;
      } else {
      ...
      const _bind$18 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--packet");
      let _tmp$16;
      if (_bind$18.$tag === 1) {
        const _ok = _bind$18;
        _tmp$16 = _ok._0;
      ...
      const _tmp$17 = _tmp$16;
      const _bind$19 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--candidate");
      let _tmp$18;
      if (_bind$19.$tag === 1) {
        const _ok = _bind$19;
        _tmp$18 = _ok._0;
      ...
      const _tmp$19 = _tmp$18;
      const _bind$20 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--review");
      let _tmp$20;
      if (_bind$20.$tag === 1) {
        const _ok = _bind$20;
        _tmp$20 = _ok._0;
      ...
      const _bind$21 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--draft");
      let _tmp$22;
      if (_bind$21.$tag === 1) {
        const _ok = _bind$21;
        _tmp$22 = _ok._0;
      ...
      const _tmp$23 = _tmp$22;
      const _bind$22 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--out");
      let _tmp$24;
      if (_bind$22.$tag === 1) {
        const _ok = _bind$22;
        _tmp$24 = _ok._0;
      ...
      return _M0FP38portable8research17researchartifacts6revise(host, _tmp$17, _tmp$19, _tmp$21, _tmp$23, _tmp$24);
    }
    case "export-peer": {
      const _bind$23 = _M0FP38portable8research20researchartifactscli12check__flags(_flags, ["--ledger", "--run", "--out", "--include"]);
      if (_bind$23.$tag === 1) {
        const _ok = _bind$23;
        _ok._0;
      } else {
      ...
      const _bind$24 = _M0MPB3Map3getGssE(_flags, "--include");
      let extra;
      if (_bind$24 === undefined) {
        extra = [];
      } else {
        ...
        const _path = _Some;
        const values = [];
        const _bind$25 = _M0FP38portable8research2io4read(host, _path);
        let _tmp$25;
        if (_bind$25.$tag === 1) {
          const _ok = _bind$25;
          _tmp$25 = _ok._0;
        ...
        const _bind$26 = _M0FP38portable8research2io5parse(_tmp$25);
        let _tmp$26;
        if (_bind$26.$tag === 1) {
          const _ok = _bind$26;
          _tmp$26 = _ok._0;
        ...
        const _bind$27 = _M0FP38portable8research2io9as__array(_tmp$26);
        let _bind$28;
        if (_bind$27.$tag === 1) {
          const _ok = _bind$27;
          _bind$28 = _ok._0;
        ...
        while (true) {
          const _ = _tmp$27;
          if (_ < _bind$29) {
            const item = _bind$28[_];
            const _bind$30 = _M0FP38portable8research2io10as__string(item);
            let _tmp$28;
            if (_bind$30.$tag === 1) {
              const _ok = _bind$30;
              _tmp$28 = _ok._0;
            ...
            _M0MPC15array5Array4pushGsE(values, _tmp$28);
            _tmp$27 = _ + 1 | 0;
            continue;
          } else {
            break;
      ...
      const _bind$25 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--ledger");
      let _tmp$25;
      if (_bind$25.$tag === 1) {
        const _ok = _bind$25;
        _tmp$25 = _ok._0;
      ...
      const _tmp$26 = _tmp$25;
      const _bind$26 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--run");
      let _tmp$27;
      if (_bind$26.$tag === 1) {
        const _ok = _bind$26;
        _tmp$27 = _ok._0;
      ...
      const _tmp$28 = _tmp$27;
      const _bind$27 = _M0FP38portable8research20researchartifactscli10need__flag(_flags, "--out");
      let _tmp$29;
      if (_bind$27.$tag === 1) {
        const _ok = _bind$27;
        _tmp$29 = _ok._0;
      ...
      return _M0FP38portable8research17researchartifacts12export__peer(host, _tmp$26, _tmp$28, _tmp$29, extra);
    }
    default: {
...
function _M0FP38portable8research20researchartifactscli8json__ok(result) {
  if (result.$tag === 6) {
...
function _M0FP38portable8research20researchartifactscli8run__cli(input, host, _async_host, done) {
  let outcome;
  let _try_err;
  _L: {
    _L$2: {
      const _bind = _M0FP38portable8research20researchartifactscli3run(input, host);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
  ...
  if (outcome.$tag === 1) {
    ...
    _L$2: {
      _L$3: {
        const _bind = _M0FP38portable8research2io5print(host, `${_M0MPC14json4Json17stringify_2einner(_result, false, 0, undefined)}\n`, false);
        if (_bind.$tag === 1) {
          const _ok = _bind;
          _ok._0;
        } else {
    ...
    let _tmp;
    if (_M0FP38portable8research20researchartifactscli8json__ok(_result)) {
      const _p = 0;
      const _p$2 = undefined;
    ...
    const _Err = outcome;
    const _message = _Err._0;
    const result = _M0FP38portable8research20researchartifactscli13err__envelope(_message);
    let _try_err$2;
    _L$2: {
      _L$3: {
...
export { _M0FP38portable8research20researchartifactscli8run__cli as run_cli }
